...
function sirec_application_form_shortcode($atts) {
    ...
    <style>
        ...
        .sirec-modal-content h2 {
            color: var(--bb-headings-color);
            margin-bottom: 20px;
            font-size: 24px;
        }

        .sirec-modal-content p {
    ...
    <div id="successModal" class="sirec-modal" style="display: none;">
        <div class="sirec-modal-content">
            <h2>¡Solicitud Enviada!</h2>
            <p>Tu solicitud ha sido enviada correctamente. Revisaremos tus respuestas y te notificaremos pronto.</p>
            <div class="elementor-button-wrapper">
                <a id="returnHomeBtn" class="elementor-button elementor-button-link elementor-size-sm" href="#">
...
function sirec_enqueue_form_assets() {
    if (has_shortcode(get_post()->post_content, 'sirec_application_form') || 
        ...
        wp_localize_script('sirec-form-script', 'sirecAjax', array(
            ...
            'homeUrl' => home_url('/') // Add this line
        ));
    }
}
